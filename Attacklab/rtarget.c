...
0000000000400f90 <initialize_target>:
  ...
  400fa7:	e8 a7 1c 00 00       	callq  402c53 <gencookie>
  400fac:	89 05 52 45 20 00    	mov    %eax,0x204552(%rip)        # 605504 <cookie>
  400fb2:	89 c7                	mov    %eax,%edi
  400fb4:	e8 9a 1c 00 00       	callq  402c53 <gencookie>
  ...
  4010ab:	00 
  4010ac:	e8 39 19 00 00       	callq  4029ea <init_driver>
...
00000000004010e0 <main>:
  ...
  401176:	ff 24 c5 78 2f 40 00 	jmpq   *0x402f78(,%rax,8)
  ...
  40126f:	e8 57 08 00 00       	callq  401acb <check_fail>
  ...
  401290:	e8 66 0c 00 00       	callq  401efb <launch>
...
0000000000401792 <getbuf>:
  ...
  401799:	e8 5c 03 00 00       	callq  401afa <Gets>
...
00000000004017a8 <touch1>:
  ...
  4017b3:	00 00 00 
  4017b6:	bf 23 31 40 00       	mov    $0x403123,%edi
  4017bb:	e8 90 f4 ff ff       	callq  400c50 <puts@plt>
  4017c0:	bf 01 00 00 00       	mov    $0x1,%edi
  4017c5:	e8 1f 05 00 00       	callq  401ce9 <validate>
...
000000000040182a <hexmatch>:
  ...
  401875:	be 40 31 40 00       	mov    $0x403140,%esi
...
000000000040190c <test>:
  ...
  40191c:	bf e8 31 40 00       	mov    $0x4031e8,%edi
...
0000000000401936 <setval_461>:
  401936:	c7 07 58 89 c7 c3    	movl   $0xc3c78958,(%rdi)
  40193c:	c3                   	retq   

000000000040193d <setval_142>:
  40193d:	c7 07 2d 5b 58 90    	movl   $0x90585b2d,(%rdi)
  401943:	c3                   	retq   

0000000000401944 <addval_397>:
  401944:	8d 87 3f 58 90 c3    	lea    -0x3c6fa7c1(%rdi),%eax
  40194a:	c3                   	retq   

000000000040194b <addval_299>:
  40194b:	8d 87 44 48 89 c7    	lea    -0x3876b7bc(%rdi),%eax
  401951:	c3                   	retq   

0000000000401952 <addval_111>:
  401952:	8d 87 c8 89 c7 c3    	lea    -0x3c387638(%rdi),%eax
  401958:	c3                   	retq   

0000000000401959 <getval_320>:
  401959:	b8 58 91 90 c3       	mov    $0xc3909158,%eax
  40195e:	c3                   	retq   

000000000040195f <setval_146>:
  40195f:	c7 07 48 89 c7 c3    	movl   $0xc3c78948,(%rdi)
  401965:	c3                   	retq   

0000000000401966 <getval_380>:
  401966:	b8 b6 58 92 90       	mov    $0x909258b6,%eax
  40196b:	c3                   	retq   

000000000040196c <mid_farm>:
  40196c:	b8 01 00 00 00       	mov    $0x1,%eax
  401971:	c3                   	retq   

0000000000401972 <add_xy>:
  401972:	48 8d 04 37          	lea    (%rdi,%rsi,1),%rax
  401976:	c3                   	retq   

0000000000401977 <setval_470>:
  401977:	c7 07 89 d6 90 c7    	movl   $0xc790d689,(%rdi)
  40197d:	c3                   	retq   

000000000040197e <getval_324>:
  40197e:	b8 48 09 e0 c3       	mov    $0xc3e00948,%eax
  401983:	c3                   	retq   

0000000000401984 <addval_270>:
  401984:	8d 87 e6 89 d6 94    	lea    -0x6b29761a(%rdi),%eax
  40198a:	c3                   	retq   

000000000040198b <setval_300>:
  40198b:	c7 07 2f 09 ca c3    	movl   $0xc3ca092f,(%rdi)
  401991:	c3                   	retq   

0000000000401992 <addval_261>:
  401992:	8d 87 89 d6 38 c0    	lea    -0x3fc72977(%rdi),%eax
  401998:	c3                   	retq   

0000000000401999 <getval_213>:
  401999:	b8 d1 89 ca 94       	mov    $0x94ca89d1,%eax
  40199e:	c3                   	retq   

000000000040199f <setval_230>:
  40199f:	c7 07 81 c1 38 c9    	movl   $0xc938c181,(%rdi)
  4019a5:	c3                   	retq   

00000000004019a6 <addval_486>:
  4019a6:	8d 87 48 89 e0 90    	lea    -0x6f1f76b8(%rdi),%eax
  4019ac:	c3                   	retq   

00000000004019ad <getval_431>:
  4019ad:	b8 8d d6 08 d2       	mov    $0xd208d68d,%eax
  4019b2:	c3                   	retq   

00000000004019b3 <addval_191>:
  4019b3:	8d 87 a9 ca 20 c0    	lea    -0x3fdf3557(%rdi),%eax
  4019b9:	c3                   	retq   

00000000004019ba <setval_392>:
  4019ba:	c7 07 89 d6 18 d2    	movl   $0xd218d689,(%rdi)
  4019c0:	c3                   	retq   

00000000004019c1 <getval_412>:
  4019c1:	b8 89 d6 28 d2       	mov    $0xd228d689,%eax
  4019c6:	c3                   	retq   

00000000004019c7 <addval_435>:
  4019c7:	8d 87 2d 4c 89 e0    	lea    -0x1f76b3d3(%rdi),%eax
  4019cd:	c3                   	retq   

00000000004019ce <getval_495>:
  4019ce:	b8 8b c1 38 c9       	mov    $0xc938c18b,%eax
  4019d3:	c3                   	retq   

00000000004019d4 <getval_226>:
  4019d4:	b8 8d ca 84 d2       	mov    $0xd284ca8d,%eax
  4019d9:	c3                   	retq   

00000000004019da <addval_360>:
  4019da:	8d 87 89 d6 28 d2    	lea    -0x2dd72977(%rdi),%eax
  4019e0:	c3                   	retq   

00000000004019e1 <addval_400>:
  4019e1:	8d 87 f5 48 89 e0    	lea    -0x1f76b70b(%rdi),%eax
  4019e7:	c3                   	retq   

00000000004019e8 <getval_127>:
  4019e8:	b8 8d c1 38 c0       	mov    $0xc038c18d,%eax
  4019ed:	c3                   	retq   

00000000004019ee <setval_288>:
  4019ee:	c7 07 c8 89 e0 c3    	movl   $0xc3e089c8,(%rdi)
  4019f4:	c3                   	retq   

00000000004019f5 <addval_411>:
  4019f5:	8d 87 68 89 e0 c3    	lea    -0x3c1f7698(%rdi),%eax
  4019fb:	c3                   	retq   

00000000004019fc <setval_286>:
  4019fc:	c7 07 48 89 e0 94    	movl   $0x94e08948,(%rdi)
  401a02:	c3                   	retq   

0000000000401a03 <setval_489>:
  401a03:	c7 07 89 c1 38 c9    	movl   $0xc938c189,(%rdi)
  401a09:	c3                   	retq   

0000000000401a0a <addval_401>:
  401a0a:	8d 87 89 c1 28 c9    	lea    -0x36d73e77(%rdi),%eax
  401a10:	c3                   	retq   

0000000000401a11 <setval_249>:
  401a11:	c7 07 48 99 e0 c3    	movl   $0xc3e09948,(%rdi)
  401a17:	c3                   	retq   

0000000000401a18 <setval_108>:
  401a18:	c7 07 89 d6 84 c9    	movl   $0xc984d689,(%rdi)
  401a1e:	c3                   	retq   

0000000000401a1f <getval_402>:
  401a1f:	b8 89 ca 38 c0       	mov    $0xc038ca89,%eax
  401a24:	c3                   	retq   

0000000000401a25 <setval_314>:
  401a25:	c7 07 89 ca 90 c3    	movl   $0xc390ca89,(%rdi)
  401a2b:	c3                   	retq   

0000000000401a2c <setval_157>:
  401a2c:	c7 07 88 ca 20 c9    	movl   $0xc920ca88,(%rdi)
  401a32:	c3                   	retq   

0000000000401a33 <setval_242>:
  401a33:	c7 07 27 81 c1 c3    	movl   $0xc3c18127,(%rdi)
  401a39:	c3                   	retq   

0000000000401a3a <getval_182>:
  401a3a:	b8 89 c1 90 90       	mov    $0x9090c189,%eax
  401a3f:	c3                   	retq   

0000000000401a40 <addval_423>:
  401a40:	8d 87 89 c1 92 c3    	lea    -0x3c6d3e77(%rdi),%eax
  401a46:	c3                   	retq   

0000000000401a47 <addval_417>:
  401a47:	8d 87 80 89 ca 94    	lea    -0x6b357680(%rdi),%eax
  401a4d:	c3                   	retq   

0000000000401a4e <end_farm>:
  401a4e:	b8 01 00 00 00       	mov    $0x1,%eax
  401a53:	c3                   	retq   
  401a54:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  401a5b:	00 00 00 
...
0000000000401acb <check_fail>:
  ...
  401aeb:	e8 90 f1 ff ff       	callq  400c80 <printf@plt>
  401af0:	bf 01 00 00 00       	mov    $0x1,%edi
  401af5:	e8 f6 f2 ff ff       	callq  400df0 <exit@plt>
...
0000000000401afa <Gets>:
  ...
  401b19:	e8 42 ff ff ff       	callq  401a60 <save_char>
  401b1e:	48 89 eb             	mov    %rbp,%rbx
  401b21:	48 8b 3d c8 39 20 00 	mov    0x2039c8(%rip),%rdi        # 6054f0 <infile>
  401b28:	e8 33 f2 ff ff       	callq  400d60 <_IO_getc@plt>
  ...
  401b3f:	e8 74 ff ff ff       	callq  401ab8 <save_term>
...
0000000000401b4c <notify_server>:
  ...
  401b87:	e8 64 f2 ff ff       	callq  400df0 <exit@plt>
  ...
  401be0:	e8 fb f1 ff ff       	callq  400de0 <sprintf@plt>
  ...
  401c1a:	e8 94 0f 00 00       	callq  402bb3 <driver_post>
  ...
  401c32:	e8 49 f0 ff ff       	callq  400c80 <printf@plt>
  401c37:	bf 01 00 00 00       	mov    $0x1,%edi
  401c3c:	e8 af f1 ff ff       	callq  400df0 <exit@plt>
  401c41:	bf 70 33 40 00       	mov    $0x403370,%edi
  401c46:	e8 05 f0 ff ff       	callq  400c50 <puts@plt>
  401c4b:	bf 53 32 40 00       	mov    $0x403253,%edi
  401c50:	e8 fb ef ff ff       	callq  400c50 <puts@plt>
  401c55:	e9 85 00 00 00       	jmpq   401cdf <notify_server+0x193>
  401c5a:	bf 5d 32 40 00       	mov    $0x40325d,%edi
  401c5f:	e8 ec ef ff ff       	callq  400c50 <puts@plt>
  ...
  401c81:	e8 fa ef ff ff       	callq  400c80 <printf@plt>
  ...
  401cad:	e8 ce ef ff ff       	callq  400c80 <printf@plt>
...
0000000000401ce9 <validate>:
  ...
  401d0c:	e8 ba fd ff ff       	callq  401acb <check_fail>
  ...
  401d31:	e8 95 fd ff ff       	callq  401acb <check_fail>
  ...
  401d4e:	e8 2d ef ff ff       	callq  400c80 <printf@plt>
  ...
  401d62:	e8 e9 ee ff ff       	callq  400c50 <puts@plt>
  401d67:	89 de                	mov    %ebx,%esi
  401d69:	bf 00 00 00 00       	mov    $0x0,%edi
  401d6e:	e8 d9 fd ff ff       	callq  401b4c <notify_server>
  ...
  401d88:	e8 f3 ee ff ff       	callq  400c80 <printf@plt>
  401d8d:	89 de                	mov    %ebx,%esi
  401d8f:	bf 01 00 00 00       	mov    $0x1,%edi
  401d94:	e8 b3 fd ff ff       	callq  401b4c <notify_server>
  401d99:	5b                   	pop    %rbx
  401d9a:	c3                   	retq   
...
0000000000401d9b <fail>:
  ...
  401dad:	e8 19 fd ff ff       	callq  401acb <check_fail>
  401db2:	89 fe                	mov    %edi,%esi
  401db4:	bf 00 00 00 00       	mov    $0x0,%edi
  401db9:	e8 8e fd ff ff       	callq  401b4c <notify_server>
...
0000000000401dc3 <bushandler>:
  ...
  401ddf:	e8 e7 fc ff ff       	callq  401acb <check_fail>
  401de4:	bf 30 34 40 00       	mov    $0x403430,%edi
  401de9:	e8 62 ee ff ff       	callq  400c50 <puts@plt>
  401dee:	bf cf 32 40 00       	mov    $0x4032cf,%edi
  401df3:	e8 58 ee ff ff       	callq  400c50 <puts@plt>
  401df8:	be 00 00 00 00       	mov    $0x0,%esi
  401dfd:	bf 00 00 00 00       	mov    $0x0,%edi
  401e02:	e8 45 fd ff ff       	callq  401b4c <notify_server>
  401e07:	bf 01 00 00 00       	mov    $0x1,%edi
  401e0c:	e8 df ef ff ff       	callq  400df0 <exit@plt>
...
0000000000401e11 <seghandler>:
  ...
  401e2d:	e8 99 fc ff ff       	callq  401acb <check_fail>
  401e32:	bf 50 34 40 00       	mov    $0x403450,%edi
  401e37:	e8 14 ee ff ff       	callq  400c50 <puts@plt>
  ...
  401e50:	e8 f7 fc ff ff       	callq  401b4c <notify_server>
  401e55:	bf 01 00 00 00       	mov    $0x1,%edi
  401e5a:	e8 91 ef ff ff       	callq  400df0 <exit@plt>
...
0000000000401efb <launch>:
  ...
  401f1b:	e8 70 ed ff ff       	callq  400c90 <memset@plt>
  ...
  401f61:	e8 ea ec ff ff       	callq  400c50 <puts@plt>
  401f66:	b8 00 00 00 00       	mov    $0x0,%eax
  401f6b:	e8 5b fb ff ff       	callq  401acb <check_fail>
  401f70:	bf 2c 33 40 00       	mov    $0x40332c,%edi
  401f75:	e8 d6 ec ff ff       	callq  400c50 <puts@plt>
  401f7a:	c9                   	leaveq 
  401f7b:	c3                   	retq   
...
0000000000401f7c <stable_launch>:
  ...
  401fa4:	e8 c7 ec ff ff       	callq  400c70 <mmap@plt>
  ...
  401fbc:	e8 bf ed ff ff       	callq  400d80 <munmap@plt>
  ...
  401fd7:	e8 24 ed ff ff       	callq  400d00 <fprintf@plt>
  401fdc:	bf 01 00 00 00       	mov    $0x1,%edi
  401fe1:	e8 0a ee ff ff       	callq  400df0 <exit@plt>
  ...
  40200b:	e8 eb fe ff ff       	callq  401efb <launch>
  ...
  402022:	e8 59 ed ff ff       	callq  400d80 <munmap@plt>
  402027:	5b                   	pop    %rbx
  402028:	c3                   	retq   
...
0000000000402042 <sigalrm_handler>:
  ...
  40205c:	e8 9f ec ff ff       	callq  400d00 <fprintf@plt>
  402061:	bf 01 00 00 00       	mov    $0x1,%edi
  402066:	e8 85 ed ff ff       	callq  400df0 <exit@plt>
...
000000000040206b <urlencode>:
  ...
  40208d:	e9 93 00 00 00       	jmpq   402125 <urlencode+0xba>
  ...
  4020fe:	e8 dd ec ff ff       	callq  400de0 <sprintf@plt>
...
0000000000402141 <rio_writen>:
  ...
  402162:	e8 f9 ea ff ff       	callq  400c60 <write@plt>
  402167:	48 85 c0             	test   %rax,%rax
  40216a:	7f 0f                	jg     40217b <rio_writen+0x3a>
  40216c:	e8 9f ea ff ff       	callq  400c10 <__errno_location@plt>
...
000000000040219d <rio_read>:
  ...
  4021be:	e8 fd ea ff ff       	callq  400cc0 <read@plt>
  4021c3:	89 43 04             	mov    %eax,0x4(%rbx)
  4021c6:	85 c0                	test   %eax,%eax
  4021c8:	79 0c                	jns    4021d6 <rio_read+0x39>
  4021ca:	e8 41 ea ff ff       	callq  400c10 <__errno_location@plt>
  ...
  4021fc:	e8 2f eb ff ff       	callq  400d30 <memcpy@plt>
...
0000000000402224 <rio_readlineb>:
  ...
  40224b:	e8 4d ff ff ff       	callq  40219d <rio_read>
...
00000000004022a7 <submitr>:
  ...
  4022ef:	e8 1c eb ff ff       	callq  400e10 <socket@plt>
  ...
  402343:	e9 68 06 00 00       	jmpq   4029b0 <submitr+0x709>
  402348:	4c 89 e7             	mov    %r12,%rdi
  40234b:	e8 a0 e9 ff ff       	callq  400cf0 <gethostbyname@plt>
  ...
  4023b7:	e9 f4 05 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  4023f1:	e8 9a e9 ff ff       	callq  400d90 <bcopy@plt>
  ...
  402416:	e8 e5 e9 ff ff       	callq  400e00 <connect@plt>
  ...
  402469:	e8 42 e8 ff ff       	callq  400cb0 <close@plt>
  40246e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402473:	e9 38 05 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  40252d:	e8 7e e7 ff ff       	callq  400cb0 <close@plt>
  402532:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402537:	e9 74 04 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  402557:	e8 0f fb ff ff       	callq  40206b <urlencode>
  ...
  4025df:	e8 cc e6 ff ff       	callq  400cb0 <close@plt>
  4025e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4025e9:	e9 c2 03 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  402611:	e8 ca e7 ff ff       	callq  400de0 <sprintf@plt>
  ...
  40263d:	e8 ff fa ff ff       	callq  402141 <rio_writen>
  ...
  4026a6:	e8 05 e6 ff ff       	callq  400cb0 <close@plt>
  4026ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4026b0:	e9 fb 02 00 00       	jmpq   4029b0 <submitr+0x709>
  4026b5:	89 ee                	mov    %ebp,%esi
  4026b7:	48 8d bc 24 20 80 00 	lea    0x8020(%rsp),%rdi
  4026be:	00 
  4026bf:	e8 6c f9 ff ff       	callq  402030 <rio_readinitb>
  ...
  4026d8:	00 
  4026d9:	e8 46 fb ff ff       	callq  402224 <rio_readlineb>
  ...
  402751:	e8 5a e5 ff ff       	callq  400cb0 <close@plt>
  402756:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  40275b:	e9 50 02 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  402787:	e8 e4 e5 ff ff       	callq  400d70 <__isoc99_sscanf@plt>
  40278c:	e9 98 00 00 00       	jmpq   402829 <submitr+0x582>
  ...
  4027a5:	00 
  4027a6:	e8 79 fa ff ff       	callq  402224 <rio_readlineb>
  ...
  402824:	e9 87 01 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  402867:	00 
  402868:	e8 b7 f9 ff ff       	callq  402224 <rio_readlineb>
  ...
  4028ea:	e8 c1 e3 ff ff       	callq  400cb0 <close@plt>
  4028ef:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4028f4:	e9 b7 00 00 00       	jmpq   4029b0 <submitr+0x709>
  ...
  40291a:	e8 c1 e4 ff ff       	callq  400de0 <sprintf@plt>
  40291f:	89 ef                	mov    %ebp,%edi
  402921:	e8 8a e3 ff ff       	callq  400cb0 <close@plt>
  402926:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  40292b:	e9 80 00 00 00       	jmpq   4029b0 <submitr+0x709>
  402930:	48 8d b4 24 20 60 00 	lea    0x6020(%rsp),%rsi
  402937:	00 
  402938:	48 89 df             	mov    %rbx,%rdi
  40293b:	e8 00 e3 ff ff       	callq  400c40 <strcpy@plt>
  402940:	89 ef                	mov    %ebp,%edi
  402942:	e8 69 e3 ff ff       	callq  400cb0 <close@plt>
...
00000000004029c2 <init_timeout>:
  ...
  4029dc:	e8 ff e2 ff ff       	callq  400ce0 <signal@plt>
  4029e1:	89 df                	mov    %ebx,%edi
  4029e3:	e8 b8 e2 ff ff       	callq  400ca0 <alarm@plt>
  4029e8:	5b                   	pop    %rbx
  4029e9:	c3                   	retq   
...
00000000004029ea <init_driver>:
  ...
  402a84:	e9 23 01 00 00       	jmpq   402bac <init_driver+0x1c2>
  402a89:	bf b0 30 40 00       	mov    $0x4030b0,%edi
  402a8e:	e8 5d e2 ff ff       	callq  400cf0 <gethostbyname@plt>
  ...
  402af1:	e8 ba e1 ff ff       	callq  400cb0 <close@plt>
  402af6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402afb:	e9 ac 00 00 00       	jmpq   402bac <init_driver+0x1c2>
  ...
  402b27:	e8 64 e2 ff ff       	callq  400d90 <bcopy@plt>
  ...
  402b3d:	e8 be e2 ff ff       	callq  400e00 <connect@plt>
...
0000000000402bb3 <driver_post>:
  ...
  402bcd:	e8 ae e0 ff ff       	callq  400c80 <printf@plt>
  ...
  402c06:	e8 9c f6 ff ff       	callq  4022a7 <submitr>
...
0000000000402c53 <gencookie>:
  ...
  402c57:	e8 c4 df ff ff       	callq  400c20 <srandom@plt>
  402c5c:	e8 ef e0 ff ff       	callq  400d50 <random@plt>
  402c61:	89 c3                	mov    %eax,%ebx
  402c63:	89 c7                	mov    %eax,%edi
  402c65:	e8 b7 ff ff ff       	callq  402c21 <check>
  402c6a:	85 c0                	test   %eax,%eax
  402c6c:	74 ee                	je     402c5c <gencookie+0x9>
  402c6e:	89 d8                	mov    %ebx,%eax
  402c70:	5b                   	pop    %rbx
  402c71:	c3                   	retq   
  402c72:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  402c79:	00 00 00 
...
0000000000402c80 <__libc_csu_init>:
  ...
  402c98:	55                   	push   %rbp
  402c99:	48 8d 2d 78 21 20 00 	lea    0x202178(%rip),%rbp        # 604e18 <__init_array_end>
  402ca0:	53                   	push   %rbx
  402ca1:	4c 29 e5             	sub    %r12,%rbp
  402ca4:	31 db                	xor    %ebx,%ebx
  402ca6:	48 c1 fd 03          	sar    $0x3,%rbp
  402caa:	48 83 ec 08          	sub    $0x8,%rsp
  402cae:	e8 15 df ff ff       	callq  400bc8 <_init>
  ...
  402cc9:	41 ff 14 dc          	callq  *(%r12,%rbx,8)
